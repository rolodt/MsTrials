var TypeDefAsync = new function ()   {
    ...
    me.incrementEstudioViews = function (searchParams) {
        ...
        var stringified = JSON.stringify(data);
        sendRequest("apiestudio/PostIncrementEstudioViews", stringified, null, null, null, null, null, "POST");
    }
    ...
    me.sendEmail = function (searchParams, externalSuccessCallback, externalFailCallback) {
        ...
        var stringified = JSON.stringify(data);
        sendRequest("apicontacto/SendEmail", stringified, null, {}, null, externalSuccessCallback, externalFailCallback, "POST");
    }
    ...
    me.subscribeToNewsletter = function (searchParams, externalSuccessCallback, externalFailCallback) {
        ...
        var stringified = JSON.stringify(data);
        sendRequest("apicontacto/SubscribeToNewsletter", stringified, null, {}, null, externalSuccessCallback, externalFailCallback, "POST");
    }
    ...
    function sendRequest(action, jsonData, errorHandler, extraParameters, successHandler, externalSuccessCallback, externalFailCallback, httpMethod) {
        ...
        $.ajax({
            ...
            success: function (a) {
                ...
                /*$(postSyncFunctions).each(function() {
                    this();
                });*/
            },
            error: function (a) {
